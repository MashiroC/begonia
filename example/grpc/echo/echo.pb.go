...
var file_echo_proto_rawDesc = []byte{
	...
	0x6c, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x10, 0x2e, 0x65, 0x63, 0x68, 0x6f,
...
var file_echo_proto_depIdxs = []int32{
	0, // 0: echo.Greeter.SayHello:input_type -> echo.HelloRequest
	1, // 1: echo.Greeter.SayHello:output_type -> echo.HelloReply
...
// GreeterClient is the client API for Greeter server.
//
...
func (c *greeterClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/echo.Greeter/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// GreeterServer is the server API for Greeter server.
